...
### Documentation
- ✅ Created `docs/phase10-cicd.md`
  - ✅ How workflows work (CI, deploy, PR checks)
...
1. Go to: `https://github.com/bahoma31-jpg/codeforge-ide/settings/secrets/actions`
2. Click **"New repository secret"**
3. Add:
   - `VERCEL_TOKEN` ← from [Vercel Tokens page](https://vercel.com/account/tokens)
