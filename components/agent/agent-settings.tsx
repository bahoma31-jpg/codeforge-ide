...
export function AgentSettings({ isOpen, onClose }: AgentSettingsProps) {
  const { config, setProvider, setApiKey, setModel, updateConfig } = useAgentStore();
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative w-[480px] max-h-[80vh] bg-[#1e1e2e] rounded-2xl border border-[#313244] shadow-2xl overflow-hidden">
        {/* Header */}
        ...
        {/* Content */}
        <div className="px-5 py-4 space-y-5 overflow-y-auto max-h-[calc(80vh-120px)]">
          {/* Provider Selection */}
          <div>
